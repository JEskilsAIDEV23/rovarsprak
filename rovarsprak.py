def rovare(fil_r, fil_s = "", encode = 'utf-8', frc = 0.5):
    ...
    # samt fråga efter namn på en sparfil, anges ett namn för sparfilen fil_s används det istället 
    # för inmatning. Som default sparas texten i formatet UTF-8. 
    ...
    #n_c och n_sum returneras främst för att skrivas till log_filen vid kryptering av Git-Repositories som 
    #innehåller många text filer
